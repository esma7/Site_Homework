...
<div class="container-fluid page-header" style="margin-bottom: 90px;">
    <div class="container">
        <div class="d-flex flex-column justify-content-center" style="min-height: 300px">
            <h3 class="display-4 text-white text-uppercase">Courses <h1 style="color:orange !important;"><?php echo $category['c_name']; ?></h1></h3>
                    ...
                    <div class="rounded overflow-hidden mb-2">
                        ...
                        <div class="bg-secondary p-4">
                            ...
                            <?php if (strlen($item['n_title']) > 30) { ?>
                                <a class="h5  mb-3 text-info text-uppercase font-weight-bold" href="<?php echo base_url('single/' . $item['n_id']); ?>"><?php echo mb_substr(($item['n_title']), 0, 20, 'UTF-8') . '...'; ?></a>
